...
export function Card({
  ...
  return (
    <As className={cn("rounded-2xl bg-card border border-border shadow-card", className)}>
      {children}
    </As>
  );
}
...
export function StatPill({
  ...
  return (
    <div className="flex-1 rounded-2xl bg-card border border-border p-3 shadow-card">

  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <Link
          to="/"
          className="text-button mt-6 inline-flex items-center justify-center rounded-lg bg-gradient-brand px-4 py-3 text-primary-foreground shadow-glow"
        >
          Back to home
        </Link>
      </div>
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <button
          ...
          className="text-button mt-6 rounded-lg bg-gradient-brand px-4 py-3 text-primary-foreground shadow-glow"
        >
          Try again
        </button>
      </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600;700&family=Noto+Sans+Bengali:wght@300;400;500;600;700&display=swap" },

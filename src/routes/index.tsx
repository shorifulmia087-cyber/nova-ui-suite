        ...
        <div className="liquid-glass rounded-lg p-card [border:none] [box-shadow:none]">
          ...
          {[
            ...
            <Link key={label} to={to} className="group">
              <div className="w-full rounded-lg flex flex-col items-center justify-center gap-1.5 py-3 transition-all active:scale-95 liquid-glass-tile text-foreground group-active:brightness-95 [border:none] [box-shadow:none]">

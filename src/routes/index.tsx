  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="px-4 mt-section">
        <div className="bg-white rounded-lg p-card border border-border">
          ...
          {[
            ...
            <Link key={label} to={to} className="group">
              <div className="w-full rounded-lg flex flex-col items-center justify-center gap-1.5 py-3 transition-all active:scale-95 liquid-glass-tile easy-earning-tile text-foreground group-active:brightness-95">
      ...
      <div className="px-4 mt-section">
        <div className="bg-card rounded-lg p-card border border-border">
